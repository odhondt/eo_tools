...
def _write_partial_download_info(path: Path, info: dict[str, Any]) -> None:
    ...
    Args:
        ...
        info: Manifest data to serialize.
...
def _normalize_polarizations(pol: str | Sequence[str]) -> list[str]:
    ...
    Args:
        pol: A single polarization, "full", or an iterable of polarizations.

    Returns:
        The selected polarizations in canonical order.

    Raises:
        ValueError: If the selection includes unsupported values.
    """
    allowed = ("vv", "vh")
